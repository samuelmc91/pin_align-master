...
def test_fmx():
    ...
    for i in range(0, len(imgs)-1, 2):
        ...
        if os.path.exists(old_out_dir):
            ...
            old_outputs = os.popen('bash /home/samuel/Desktop/Projects/pin_align-master/FMX/pin_align-old/pin_align_fmx.sh ' + os.path.basename(run_img_0) + ' ' + os.path.basename(run_img_90)).readlines()
