...
PIN_ALIGN_DEFAULT_ROI_HEIGHT=$((380))

PIN_ALIGN_DEFAULT_ROI_WIDTH_OFFSET=$((350))
PIN_ALIGN_DEFAULT_ROI_HEIGHT_OFFSET=$((315))

PIN_ALIGN_DEFAULT_IMAGE_WIDTH_CENTER=$((404))
...
BOTTOM_PIN_CROP_WINDOW="0x${PIN_CROP_DEFAULT_IMAGE_HEIGHT}+${PIN_BOTTOM_WIDTH_OFFSET}+${PIN_BOTTOM_HEIGHT_OFFSET}"
############################################################
