...
if [ -d /Users/samuel/Desktop/GitHub/pin_align-master ]; then
   export PIN_ALIGN_ROOT=/Users/samuel/Desktop/GitHub/pin_align-master
fi
...
$PIN_ALIGN_ROOT/pin_align_prep_amx.sh $XZ ${tmp_dir}/${fbase}_1_pin.pgm \
${tmp_dir}/${fbase}_1_body.pgm ${tmp_dir}/${fbase}_1_base.pgm> ${tmp_dir}/${fbase}_1.mvg
$PIN_ALIGN_ROOT/pin_align_prep_amx.sh $XY ${tmp_dir}/${fbase}_2_pin.pgm \
